...
def plot_stream_metrics(throughput_window=5, quality_order=None):
    ...
    plt.savefig("graphs/buffer.png", bbox_inches="tight")
    plt.close()
    ...
    plt.title("Throughput e Média Móvel por Segmento")
    plt.legend()
    ...
    plt.savefig("graphs/quality.png", bbox_inches="tight")
    plt.close()